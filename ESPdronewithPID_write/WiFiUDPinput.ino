...
void rc_compute()
{
  ...
  //THROTTLE
  rcInput[3] = map(thrInput, 0, 100, 0, 179);   //Throttle limiting and arming is handled by Motors file
}
...
{
    String feedback = "";
    feedback += motorValue[0];
    feedback += ",";
    feedback += motorValue[1];
    feedback += ",";
    feedback += motorValue[2];
    feedback += ",";
    feedback += motorValue[3];
    feedback += ",";
    feedback += ypr[0];
    feedback += ",";
    feedback += ypr[1];
    ...
    char charBuf[150];
    feedback.toCharArray(charBuf, 255);
    
    UdpPort[2].beginPacket(UdpPort[2].remoteIP(), UdpPort[2].remotePort());
    UdpPort[2].write(charBuf);
    UdpPort[2].endPacket();
}
//======================================================================================
