...
#define ROLL_PID_MIN  -70.0
#define ROLL_PID_MAX  70.0

#define PITCH_PID_MIN  -70.0
#define PITCH_PID_MAX  70.0

#define ROLL_PID_SMIN  -100.0
#define ROLL_PID_SMAX  100.0

#define PITCH_PID_SMIN  -100.0
#define PITCH_PID_SMAX  100.0
...
float prStabKp=0.0,   prStabKi=0.0,    prStabKd=0.0;
...
float pitchOffset = -2.66;
float rollOffset = 0.23;
float yawOffset = 0;

//----------MOTORS----------//

//Motors arming throttle limit
#define ARMING_THR_LIMIT 10
...
//UDP Parameters
//=======================================================================================
unsigned int localPort[NO_OF_PORTS] = {7000, 5000, 7016};
//=======================================================================================
