...
void motor_compute_outputs()
{
  ...
  motorValue[0] = double(rcInput[3]) - pidRateOut[1] - pidRateOut[2] - pid_output_yaw;
  motorValue[1] = double(rcInput[3]) + pidRateOut[1] + pidRateOut[2] - pid_output_yaw;
  motorValue[3] = double(rcInput[3]) - pidRateOut[1] + pidRateOut[2] + pid_output_yaw;
  motorValue[2] = double(rcInput[3]) + pidRateOut[1] - pidRateOut[2] + pid_output_yaw;//Reversed due to reversed motors
