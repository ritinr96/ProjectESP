...
void udp_input()
{
  ...
  if(rcInput[3] < 1050 && rcInput[0] < -47)start = 1;
  //When yaw stick is back in the center position start the motors (step 2).
  if(start == 1 && rcInput[3] < 1080 && rcInput[0] > -5){
    start = 2;
  ...
  if(start == 2 && rcInput[3] < 1080 && rcInput[4] > 47)start = 0;
...
void rc_compute()
{
  ...
  if (yawInput > -5 && yawInput < 5)
    ...
    rcInput[0] = map(yawInput, -50, 50, 30, -30);//NOT Reversed RCINPUT here
